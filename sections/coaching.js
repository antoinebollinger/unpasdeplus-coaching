...
export default function Coaching() {
    return (
        <section id="coaching" className="bg-gray-100 pricing-area py-120">
            <div className="container">
                ...
                <div className="justify-center row my-10">
                    <div className="pb-10 text-center section-title">
                        <h4 className="services-title">Un accompagnement de qualité, complet, avec bienveillance, professionnalisme et éthique</h4>
                        <p className="text">Un accompagnement et un suivi personnalisé</p>
                    </div>
                    <div className="w-full mx-4 lg:w-1/2 flex gap-1 items-center bg-white mb-10">
                    ...
                    <div className="w-full mx-4 lg:w-1/2 ">
                        <ul>
                            <li><FontAwesomeIcon icon={faCircleCheck} /> Coach professionnel certifié RNCP 7</li>
                            ...
                            <li><FontAwesomeIcon icon={faCircleCheck} /> Séances individuelles 1h-1h15</li>
                            <li><FontAwesomeIcon icon={faCircleCheck} /> Bilan en mi-parcours et en fin de parcours pour évaluer le chemin parcouru, les indicateurs préalablement définis</li>
                        </ul>
                    </div>
                </div>
            </div>
