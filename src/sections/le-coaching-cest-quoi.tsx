...
export default function LeCoachingCestQuoi() {
    useEffect(() => {
        reveal({
            collection: Array.from(document.querySelectorAll('.intro-step')),
        ...
        <section id="le-coaching-cest-quoi">
            <div className="container">
                ...
                <div className="lg:max-w-4xl mx-auto">
                    ...
                    {list(
                        Intro4,
                        "<strong>Mon métier repose sur une écoute active</strong>, un questionnement pertinent et des outils & méthodes de coaching, dans un cadre confidentiel. Dans ce cadre, je propose un accompagnement individuel où nous explorons votre demande et définissons un objectif à la fois atteignable et challengeant."
                    )}
                    {list(
                        Intro5,
                        "J'accompagne les personnes à faire <strong>UN PAS DE PLUS</strong> dans leur épanouissement personnel et/ou professionnel pour un changement profond et durable."
                    )}
                </div>
            </div>
        </section>
