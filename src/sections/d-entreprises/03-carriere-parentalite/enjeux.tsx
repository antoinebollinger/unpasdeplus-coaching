            ...
            <div className="container">
                <div className="w-full lg:w-2/3 mx-auto flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <p className="text-lg leading-6 transition duration-200 opacity-0 translate-y-full">
                            Ces <strong>défis à la fois personnels et professionnels</strong> peuvent avoir des répercussions sur la <strong>santé physique et mentale</strong> des salariés. Ces défis peuvent être sources de <strong>risques psychosociaux</strong> au travail.
                        </p>
                    </div>
                </div>
            </div>
