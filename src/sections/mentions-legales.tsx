        ...
        <section id="legals" className="pb-120 legals">
            <div className="container">
                ...
                <p>
                    ...
                    UN PAS DE PLUS – 56000 Vannes<br />
                    SIRET: 851 105 775 00015<br />
                    Téléphone: +33(0)6 61 79 46 99<br />
                    Courriel: <a href="mailto:sabrina.appriou@hotmail.fr">sabrina.appriou@hotmail.fr</a><br />
                    Directrice de la publication: Sabrina Appriou<br />
                    Conception et réalisation: <a href="https://antoinebollinger.fr">antoinebollinger.fr</a><br />
                ...
                <p>
                    En saisissant ses informations et ses coordonnées sur l’un des sites d'UN PAS DE PLUS, le client reconnaît accepter recevoir des informations / publications de la part de la société par email et accepter de recevoir la newsletter.Il est libre de se désinscrire à tout instant.Il suffit pour cela de cliquer sur le lien présent à la fin des emails ou par mail: <a href="mailto:sabrina.appriou@hotmail.fr">sabrina.appriou@hotmail.fr</a>. Les traitements de données personnelles réalisés au sein de ce site font l’objet d’une déclaration auprès de la CNIL n°2028730v0.
                </p>
