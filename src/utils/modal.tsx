                        ...
                        <div className="p-6 text-center">
                            ...
                            <div id="modal-buttons">
                                <div className="flex justify-around gap-8">
                                    ...
                                    <button data-href={href} className="modal-link w-full text-center text-white bg-orange-900 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5" onClick={() => close(true)}>Valider</button>
                                </div>
                            </div>
                        </div>
                    </div>
